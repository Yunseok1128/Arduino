...
#define TRIG1 2 // 초으파 센서 1번 Trig 핀 번호
#define ECHO1 3 // 초음파 센서 1번 Echi 핀 번호

#define TRIG2 4 // 초으파 센서 2번 Trig 핀 번호
#define ECHO2 5 // 초음파 센서 2번 Echi 핀 번호

#define TRIG3 6 // 초으파 센서 3번 Trig 핀 번호
#define ECHO3 7 // 초음파 센서 3번 Echi 핀 번호
